...
function showTable() {
    const table1 = document.getElementById('starTable');
    table1.style.display = 'table';
    table1.style.visibility = 'visible';
}

function hideTable() {
    const table2 = document.getElementById('starTable');
...
function rerrorhide() {
    const errormessage1 = document.getElementById('Star-Search-Errorid');
    errormessage1.style.visibility = 'hidden';
}

function rerrorshow() {
    const errormessage2 = document.getElementById('Star-Search-Errorid');
...
const card = document.querySelector(".Star-Search-Error");
